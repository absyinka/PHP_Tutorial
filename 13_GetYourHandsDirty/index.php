	...
	<body>
		<div class="wrapper">
			...
			<div class="sandbox">
				...
				<?php
					if ($species == "Black Goat") {
         
				        echo "<p>Welcome, Black Goat. You and the rest of the goats will love this peel of yam.</p>";

				    } elseif ($species == "Human") {
				         
				        echo "<p>Welcome, Human! Please leave the black goat alone.</p>";
				...
				<?php
					...
					} elseif ($species == "Black Goat") {
						
						echo "<p>Oh! You must be a goat.</p>";
						
					} else {
						
						echo "<p>Well then, you do not speak German, nor are you a goat.</p>";
