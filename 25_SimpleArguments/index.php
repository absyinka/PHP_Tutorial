...
&lt;?php
	...
	function myLocation($area) {
		
		echo "I am currently in $area!<br>";
...
?&gt;
			...
			<div class="navs cf">
				<a href="../24_CustomFunctions" class="button prev">Previous Lecture</a>
